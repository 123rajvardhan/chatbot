...
intro=["this is vardhan","myself vardhan"]
...
while True:
	...
	if a.lower() in hellow:
		botans = ["Hello ! How can i help you","hi! How can i help you ","hi there ! How can i help you","welcome ! How can i help you"]
	...
	elif a.lower() in intro:
		botans = ["Nice to meet you vardhan","Nice to see you vardhan"]
		print('Bot said - '+random.choice(botans)+'\n')
